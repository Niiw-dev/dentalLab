    ...
    <div class="asw-widget">
        ...
        <div class="asw-menu">
            ...
            <div class="asw-menu-header">ACCESIBILIDAD
                <div>
                    <div role="button" class="asw-menu-reset" title="Reiniciar">
                        <i class="bi bi-arrow-counterclockwise" style="font-size: 28px;"></i>
                    </div>
                    <div role="button" class="asw-menu-close" title="Cerrar accesibilidad Menu">
            ...
            <div class="asw-menu-content">
                <div class="asw-card" style="margin-top: 15px;">
                    ...
                    <div class="asw-adjust-font">
                        <div class="label">
                            <span class="material-icons" style="margin-right:8px;">format_size</span> Tamaño de letra
                        </div>
                        <div>
